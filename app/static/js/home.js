...
function getData(){
	...
	if (typeof(Storage) !== "undefined") {
		...
		resultTracks = dataHold["resultTracks"];
		dataHold = JSON.parse(localStorage.getItem("SPEROTracks"));
		Tracks = dataHold["Tracks"];
		dataHold = JSON.parse(localStorage.getItem("SPEROfocusGrades"));
		focusGrades = dataHold["focusGrades"];
